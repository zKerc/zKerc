...
public class PrewittFilter {
    ...
    public static BufferedImage applyPrewittFilter(BufferedImage image) {
        ...
        for (int y = 1; y < height - 1; y++) {
            for (int x = 1; x < width - 1; x++) {
                ...
                int gx = (Z3 + Z6 + Z9) - (Z1 + Z4 + Z7);
                int gy = (Z7 + Z8 + Z9) - (Z1 + Z2 + Z3);

                // Calcula a magnitude do gradiente de Prewitt
